const web = {
  init: function() {
    ...
    const pickAvatar1 = function(e) {
      const img1 = document
        .getElementById("avatars1")
        .getElementsByClassName("avatar-1");
      const img2 = document
        .getElementById("avatars1")
        .getElementsByClassName("avatar-2");
      const img3 = document
        .getElementById("avatars1")
        .getElementsByClassName("avatar-3");
    ...
    const pickAvatar2 = function(e) {
      const img1 = document
        .getElementById("avatars2")
        .getElementsByClassName("avatar-4");
      const img2 = document
        .getElementById("avatars2")
        .getElementsByClassName("avatar-5");
      const img3 = document
        .getElementById("avatars2")
        .getElementsByClassName("avatar-6");
...
function showWinnerX(winnerX) {
  ...
  winnerScreen.style.cssText =
    "width: 360px; height: 360px; background: transparent; padding-top: 36px; font-size: 64px; line-height: 75px; font-weight: bold; text-transform: uppercase; color: #FD8328";
}
...
function showWinnerO(winnerO) {
  ...
  winnerScreen.style.cssText =
    "width: 360px; height: 360px; background: transparent; padding-top: 36px; font-size: 64px; line-height: 75px; font-weight: bold; text-transform: uppercase; color:#B5EAD3";
}
...
function showDraw(draw) {
  ...
  winnerScreen.style.cssText =
    "width: 360px; height: 360px; background: transparent; padding-top: 36px; font-size: 64px; line-height: 75px; font-weight: bold; text-transform: uppercase; color: #FBC375";
}
//...................................
